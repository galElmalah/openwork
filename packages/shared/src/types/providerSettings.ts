...
export const PROVIDER_META: Record<ProviderId, ProviderMeta> = {
  ...
  zai: { id: 'zai', name: 'Z-AI (Chinese)', category: 'classic', label: 'Service', logoKey: 'z-ai', helpUrl: 'https://open.bigmodel.cn/' },
  'zai-international': { id: 'zai-international', name: 'Z-AI (International)', category: 'classic', label: 'Service', logoKey: 'z-ai', helpUrl: 'https://api.z.ai/' },
